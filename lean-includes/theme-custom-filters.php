...
if( using_native_seo() ) {
    ...
    function seo_titles() {
        ...
        include_once( get_stylesheet_directory() . '/lib/seotitles/seotitles.php' );
...
function add_plugin( $str_path ) {
    if( ! in_array( get_stylesheet_directory() . $str_path, apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
        include_once( get_stylesheet_directory() . $str_path );
    } // end if
} // end add_plugin

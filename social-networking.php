...
$html = '<ul class="nav navbar-nav navbar-left nav-pills clearfix social-networking-icons">';
foreach( $social_icons_urls as $icon_url ) {
    ...
    if( isset( $url ) || '' != esc_url( $icon ) ) {
        ...
        if( strpos( $icon, 'twitter.png' ) > 0 ) {
            $font_awesome_icon_class = 'social-icon fa fa-twitter';
        } else if( strpos( $icon, 'facebook.png' ) > 0 ) {
            $font_awesome_icon_class = 'social-icon fa fa-facebook';
        } else if( strpos( $icon, 'email.png' ) > 0 ) {
            $font_awesome_icon_class = 'social-icon fa fa-envelope';
        } else if( strpos( $icon, 'github.png' ) > 0 ) {
            $font_awesome_icon_class = 'social-icon fa fa-github';
        } else if (strpos( $icon, 'dribbble.png' ) > 0 ) {
            $font_awesome_icon_class = 'social-icon fa fa-dribbble';
        } else if (strpos( $icon, 'foursquare.png' ) > 0 ) {
            $font_awesome_icon_class = 'social-icon fa fa-foursquare';
        } else if (strpos( $icon, 'google_plus.png' ) > 0 ) {
            $font_awesome_icon_class = 'social-icon fa fa-google-plus';
        } else if (strpos( $icon, 'pinterest.png' ) > 0 ) {
            $font_awesome_icon_class = 'social-icon fa fa-pinterest';
        } else if (strpos( $icon, 'linkedin.png' ) > 0 ) {
            $font_awesome_icon_class = 'social-icon fa fa-linkedin';
        } else if (strpos( $icon, 'youtube.png' ) > 0 ) {
            $font_awesome_icon_class = 'social-icon fa fa-youtube';
        } else if (strpos( $icon, 'vimeo.png' ) > 0 ) {
            $font_awesome_icon_class = 'social-icon fa fa-vimeo-square';
        } else if (strpos( $icon, 'soundcloud.png' ) > 0 ) {
            $font_awesome_icon_class = 'social-icon fa fa-cloud';
        } else if (strpos( $icon, 'instagram.png' ) > 0 ) {
            $font_awesome_icon_class = 'social-icon fa fa-instagram';
        } else if (strpos( $icon, 'rss.png' ) > 0 ) {
            $font_awesome_icon_class = 'social-icon fa fa-rss';
